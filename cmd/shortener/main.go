package main
// этот пакет мне трудно разбивать из-за тестов и хендлеров,
// которые стали методами структуры App. Если структура App вместе с хендлерами
// переедет в отдельный пакет, тогда тесты к ним?
import (
	"io"
	"net/http"
	"strconv"
